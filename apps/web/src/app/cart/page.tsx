            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-sm p-6 sticky top-8">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  {(() => {
                    const totalSubtotal = cart.sellers?.reduce((sum, sellerCart) => sum + sellerCart.subtotal, 0) || 0;
                    const totalItemCount = cart.sellers?.reduce((sum, sellerCart) =>
                      sum + sellerCart.items.reduce((itemSum, item) => itemSum + item.quantity, 0), 0) || 0;
                    const fees = calculateFees(totalSubtotal, totalItemCount);
                    ...
                    return (
                      <>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            <span>Spedizione totale</span>
                            <span>{formatPrice(fees.shippingCost)}</span>
                          </div>
                          <div className="flex justify-between text-gray-600">
                            <span className="flex items-center">
                              Commissione piattaforma (8%)
                              <Link href="/pricing" className="ml-1">
                          ...
                          <div className="flex justify-between text-gray-600">
                            ...
                            <span>{formatPrice(fees.buyerProtectionFee)}</span>
                          </div>
                          <div className="flex justify-between text-gray-600">
                            <span className="flex items-center">
                              Costi di gestione
                        ...
                        <div className="flex justify-between font-bold text-lg">
                          ...
                          <span className="text-wine-600">{formatPrice(fees.totalAmount)}</span>
                        </div>
