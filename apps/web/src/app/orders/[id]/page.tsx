...
export default function OrderDetailPage() {
  ...
  const isBuyer = order && session?.user?.id && order.buyer.id === session.user.id
              ...
              <div className="space-y-3">
                {isBuyer && order.status === 'SHIPPED' && (
                  <button
                    ...
                    className="w-full inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {confirmingDelivery ? (
                      <>
